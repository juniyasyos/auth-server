 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $=e=>{for(const t in e)if(t.startsWith("aria-")||t==="role"||t==="title")return!0;return!1},T=m.createContext({}),B=()=>m.useContext(T),J=m.forwardRef(({color:e,size:t,strokeWidth:r,absoluteStrokeWidth:s,className:a="",children:o,iconNode:h,...c},u)=>{const{size:i=24,strokeWidth:l=2,absoluteStrokeWidth:g=!1,color:S="currentColor",className:p=""}=B()??{},k=s??g?Number(r??l)*24/Number(t??i):r??l;return m.createElement("svg",{ref:u,..._,width:t??i??_.width,height:t??i??_.height,stroke:e??S,strokeWidth:k,className:j("lucide",p,a),...!o&&!$(c)&&{"aria-hidden":"true"},...c},[...h.map(([b,n])=>m.createElement(b,n)),...Array.isArray(o)?o:[o]])});/**
 * @license lucide-react v1.7.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
